...
exports.AlgorandProjectManifestVersioned = exports.manifestIsV1_0_0 = void 0;
...
class AlgorandProjectManifestVersioned {
    ...
    constructor(projectManifest) {
        const klass = ALGORAND_SUPPORTED_VERSIONS[projectManifest.specVersion];
        if (!klass) {
...
exports.AlgorandProjectManifestVersioned = AlgorandProjectManifestVersioned;
