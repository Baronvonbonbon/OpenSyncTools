...
export const rpcHookFuncArguments = () => {
    return [
        objectPattern([t.objectProperty(t.identifier('rpc'), t.identifier('rpc'), false, true)], t.tsTypeAnnotation(t.tsTypeLiteral([
 ...
 * @returns {ParseResult} created AST
 */
export const createScopedRpcHookFactory = (context, obj, identifier, instantHooksMapping) => {
