...
export const documentRpcClient = (context, service) => {
    const methods = Object.entries(service.svc.methods).reduce((m, [key, method]) => {
        const variable = t.variableDeclaration('const', [
            t.variableDeclarator(identifier('request', t.tsTypeAnnotation(t.tsTypeReference(t.identifier(method.requestType)))))
        ]);
        if (method.comment) {
            ...
            ...m,
            {
                ...
                asts: [
                    ...
                    t.variableDeclaration('const', [
                        t.variableDeclarator(t.identifier('result'), t.awaitExpression(t.callExpression(memberExpressionOrIdentifier([methodName, ...service.ref.proto.package.split('.').reverse()]), [t.identifier('request')])))
                    ])
                ]
            }
        ];
...
export const documentRpcClients = (context, services) => {
...
export const documentRpcClientsReadme = (context, services) => {
