...
export const createAminoConverterItem = ({ root, context, proto }) => {
    ...
    const toAmino = !context.options.aminoEncoding.useLegacyInlineEncoding ?
        t.memberExpression(t.identifier(proto.name), t.identifier('toAmino')) : toAminoJsonMethod({
        context,
        proto
    });
    const fromAmino = !context.options.aminoEncoding.useLegacyInlineEncoding ?
        t.memberExpression(t.identifier(proto.name), t.identifier('fromAmino')) : fromAminoJsonMethod({
        context,
        proto
    });
...
export const createAminoConverter = ({ name, root, context, protos }) => {
