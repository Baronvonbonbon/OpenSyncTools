...
;
export const toAminoParseField = ({ context, field, currentProtoPath, scope: previousScope, fieldPath: previousFieldPath, nested, isOptional }) => {
...
export const toAminoJsonMethod = ({ context, proto }) => {
