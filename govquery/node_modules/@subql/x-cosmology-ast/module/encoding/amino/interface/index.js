...
import { protoFieldsToArray, getAminoTypeName } from '../utils';
import { aminoInterface } from './utils';
import { getFieldOptionality, getOneOfs } from '../../proto';
;
export const renderAminoField = ({ context, field, currentProtoPath, isOptional }) => {
    const args = {
        context,
        field,
        currentProtoPath,
...
;
export const makeAminoTypeInterface = ({ context, proto }) => {
