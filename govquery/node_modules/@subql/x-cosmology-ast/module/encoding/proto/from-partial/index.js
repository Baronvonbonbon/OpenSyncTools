...
export const fromPartialMethod = (context, name, proto) => {
    ...
    if (useExact === true) {
        ...
        // param
        param = identifier(varName, t.tsTypeAnnotation(t.tsTypeReference(t.identifier(partialName), t.tsTypeParameterInstantiation([
            t.tsTypeReference(t.identifier(name))
        ]))));
    }
    return objectMethod('method', t.identifier('fromPartial'), [
        param
    ], t.blockStatement([
        // init
