...
export const fromPartial = {
    ...
    long(args) {
        ...
        return setNotUndefinedAndNotNull(prop, TypeLong.getFromValueWithArgs(args.context, t.memberExpression(t.identifier('object'), t.identifier(prop))), getDefaultTSTypeFromProtoType(args.context, args.field, args.isOneOf), args);
    },
    int64(args) {
    ...
    keyHash(args) {
        ...
        return t.expressionStatement(t.assignmentExpression('=', t.memberExpression(t.identifier('message'), t.identifier(prop)), callExpression(t.memberExpression(t.callExpression(t.memberExpression(t.identifier('Object'), t.identifier('entries')), [
