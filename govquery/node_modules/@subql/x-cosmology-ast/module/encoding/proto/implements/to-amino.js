...
export const getInterfaceToAminoName = (str) => {
    return firstUpper(slugify(str) + '_ToAmino');
};
export const createInterfaceToAmino = (context, ref, interfaceName) => {
    ...
    return createInterfaceToAminoHelper(context, getInterfaceToAminoName(interfaceName), typeRefs);
};
const makeFunctionWrapper = (context, functionName, stmt, returnType) => {
    return t.exportNamedDeclaration(t.variableDeclaration('const', [
        t.variableDeclarator(t.identifier(functionName), arrowFunctionExpression([
            identifier('content', t.tsTypeAnnotation(t.tsTypeReference(t.identifier('Any')))),
...
export const createInterfaceToAminoHelper = (context, functionName, typeRefs) => {
    // MARKED AS NOT DRY
