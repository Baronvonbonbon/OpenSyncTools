...
export const getInterfaceFromAminoName = (str) => {
...
const makeFunctionWrapper = (functionName, stmt) => {
    return t.exportNamedDeclaration(t.variableDeclaration('const', [
        t.variableDeclarator(t.identifier(functionName), t.arrowFunctionExpression([
            identifier('content', t.tsTypeAnnotation(t.tsTypeReference(t.identifier('AnyAmino'))))
        ], t.blockStatement([
            stmt
        ])))
    ]));
};
export const createInterfaceFromAmino = (context, ref, interfaceName) => {
...
export const createInterfaceFromAminoHelper = (context, functionName, typeRefs) => {
