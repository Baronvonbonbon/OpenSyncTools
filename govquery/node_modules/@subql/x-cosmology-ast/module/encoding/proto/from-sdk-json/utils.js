...
export const fromSDKJSON = {
    ...
    long(args) {
        ...
        return t.objectProperty(t.identifier(origName), t.conditionalExpression(t.callExpression(t.identifier('isSet'), [
            t.memberExpression(t.identifier('object'), t.identifier(origName))
        ]), TypeLong.getFromValueWithArgs(args.context, t.memberExpression(t.identifier('object'), t.identifier(origName))), getDefaultTSTypeFromProtoType(args.context, args.field, args.isOneOf)));
    },
    int64(args) {
    ...
    keyHash(args) {
        ...
        switch (valueType) {
            ...
            case 'sfixed64':
                ...
                fromSDKJSON = TypeLong.getFromValueWithArgs(args.context, t.tsAsExpression(t.identifier('value'), t.tsUnionType([
