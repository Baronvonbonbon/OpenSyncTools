...
const needsImplementation = (name, field) => {
    throw new Error(`need to implement fromSDKJSON (${field.type} rules[${field.rule}] name[${name}])`);
};
export const fromSDKJSONMethodFields = (context, name, proto) => {
...
export const fromSDKJSONMethod = (context, name, proto) => {
    ...
    return objectMethod('method', t.identifier('fromSDKJSON'), [identifier(varName, t.tsTypeAnnotation(t.tsAnyKeyword()), false)], t.blockStatement([t.returnStatement(t.objectExpression(fields))]), false, false, false, t.tsTypeAnnotation(t.tsTypeReference(t.identifier(SDKTypeName))));
};
