...
export const toJSONMethodFields = (context, name, proto) => {
...
export const toJSONMethod = (context, name, proto) => {
    const fields = toJSONMethodFields(context, name, proto);
    let varName = 'message';
    if (!fields.length) {
        varName = '_';
    }
    return objectMethod('method', t.identifier('toJSON'), [
    ...
    ]), false, false, false, t.tsTypeAnnotation(t.tsUnknownKeyword()));
};
