...
const processEnumComment = (e) => {
    ...
    const comments = lines.map((line, i) => {
        if (i == 0)
            return line;
        if (i == 1)
            return ` * ${e.name} - ${cleanComment(line)}`;
        if (i == (lines.length - 1))
...
export const createProtoEnumFromJSON = (context, name, proto) => {
    ...
    return t.exportNamedDeclaration(functionDeclaration(t.identifier(getEnumFromJsonName(name)), [
...
export const createProtoEnumToJSON = (context, name, proto) => {
    ...
    return t.exportNamedDeclaration(functionDeclaration(t.identifier(getEnumToJsonName(name)), [
        identifier('object', t.tsTypeAnnotation(t.tsTypeReference(t.identifier(name))))
    ], t.blockStatement([
        t.switchStatement(t.identifier('object'), [
            ...switches,
            // unrecognized
