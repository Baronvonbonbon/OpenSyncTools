...
export const types = {
    ...
    */
    ...
    int64(num, prop, isOptional, args) {
        return t.ifStatement(wrapOptional(prop, TypeLong.getLongNotZero(prop, args.context), isOptional, args), scalarType(num, prop, 'int64', args));
    },
    //   if (!message.sint64Value.isZero()) {
    //     writer.uint32(24).sint64(message.sint64Value);
    //   }
    sint64(num, prop, isOptional, args) {
        return t.ifStatement(wrapOptional(prop, TypeLong.getLongNotZero(prop, args.context), isOptional, args), scalarType(num, prop, 'sint64', args));
    },
    //   if (!message.int64Value.isZero()) {
    //     writer.uint32(24).uint64(message.int64Value);
    //   }
    uint64(num, prop, isOptional, args) {
        return t.ifStatement(wrapOptional(prop, TypeLong.getLongNotZero(prop, args.context), isOptional, args), scalarType(num, prop, 'uint64', args));
    },
    fixed64(num, prop, isOptional, args) {
        return t.ifStatement(wrapOptional(prop, TypeLong.getLongNotZero(prop, args.context), isOptional, args), scalarType(num, prop, 'fixed64', args));
    },
    sfixed64(num, prop, isOptional, args) {
        return t.ifStatement(wrapOptional(prop, TypeLong.getLongNotZero(prop, args.context), isOptional, args), scalarType(num, prop, 'sfixed64', args));
    },
