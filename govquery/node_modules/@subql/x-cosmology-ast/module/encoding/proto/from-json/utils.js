...
export const fromJSON = {
    ...
    string(args) {
        ...
        return t.objectProperty(t.identifier(messageProp), t.conditionalExpression(t.callExpression(t.identifier('isSet'), [
    ...
    long(args) {
        ...
        return t.objectProperty(t.identifier(messageProp), t.conditionalExpression(t.callExpression(t.identifier('isSet'), [
            t.memberExpression(t.identifier('object'), t.identifier(objProp))
        ]), TypeLong.getFromValueWithArgs(args.context, t.memberExpression(t.identifier('object'), t.identifier(objProp))), getDefaultTSTypeFromProtoType(args.context, args.field, args.isOneOf)));
    },
    int64(args) {
    ...
    type(args) {
        ...
        return t.objectProperty(t.identifier(messageProp), t.conditionalExpression(t.callExpression(t.identifier('isSet'), [
            t.memberExpression(t.identifier('object'), t.identifier(objProp))
        ]), t.callExpression(t.memberExpression(t.identifier(name), t.identifier('fromJSON')), [
            t.memberExpression(t.identifier('object'), t.identifier(objProp))
    ...
    enum(args) {
        ...
        return t.objectProperty(t.identifier(messageProp), t.conditionalExpression(t.callExpression(t.identifier('isSet'), [
            t.memberExpression(t.identifier('object'), t.identifier(objProp))
        ]), t.callExpression(t.identifier(fromJSONFuncName), [
            t.memberExpression(t.identifier('object'), t.identifier(objProp))
    ...
    keyHash(args) {
        ...
        switch (valueType) {
            ...
            case 'sfixed64':
                ...
                fromJSON = TypeLong.getFromValueWithArgs(args.context, t.tsAsExpression(t.identifier('value'), t.tsUnionType([
        ...
        return t.objectProperty(t.identifier(messageProp), t.conditionalExpression(t.callExpression(t.identifier('isObject'), [
            t.memberExpression(t.identifier('object'), t.identifier(objProp))
    ...
    array(args, expr) {
        const { messageProp, objProp } = getPropNames(args.field);
        return t.objectProperty(t.identifier(messageProp), t.conditionalExpression(t.callExpression(t.memberExpression(t.identifier('Array'), t.identifier('isArray')), [
            t.optionalMemberExpression(t.identifier('object'), t.identifier(objProp), false, true)
        ]), t.callExpression(t.memberExpression(t.memberExpression(t.identifier('object'), t.identifier(objProp)), t.identifier('map')), [
            t.arrowFunctionExpression([
...
export const arrayTypes = {
    ...
    bool() {
        return t.callExpression(t.identifier('Boolean'), [
            t.identifier('e')
        ]);
    },
    ...
    enum(args) {
        const fromJSONFuncName = args.context.getFromEnum(args.field);
        return t.callExpression(t.identifier(fromJSONFuncName), [
            t.identifier('e')
        ]);
    },
    ...
    type(args) {
        ...
        return t.callExpression(t.memberExpression(t.identifier(name), t.identifier('fromJSON')), [
            t.identifier('e')
        ]);
    }
};
