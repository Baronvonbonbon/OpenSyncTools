...
import { arrayTypes, fromAmino as fromAminoJSON, fromAminoMessages, } from "./utils";
...
export const fromAminoMethodFields = (context, name, proto) => {
...
export const fromAminoJSONMethod = (context, name, proto) => {
    ...
    const param = identifier(varName, t.tsTypeAnnotation(t.tsTypeReference(t.identifier(aminoTypeName))));
    let body = [];
    if (proto.type === "Type") {
        switch (proto.name) {
            case "Duration": {
    ...
    if (!body.length) {
        ...
        body = [
            ...
            t.variableDeclaration("const", [
                t.variableDeclarator(t.identifier("message"), t.callExpression(t.identifier(getBaseCreateTypeFuncName(name)), [])),
            ]),
            ...fields,
            // RETURN
    ...
    return objectMethod("method", t.identifier("fromAmino"), [param], t.blockStatement(body), false, false, false, t.tsTypeAnnotation(t.tsTypeReference(t.identifier(name))));
};
export const fromAminoMsgMethod = (context, name, proto) => {
    ...
    return objectMethod("method", t.identifier("fromAminoMsg"), [
        identifier(varName, t.tsTypeAnnotation(t.tsTypeReference(t.identifier(AminoMsgName))), false),
