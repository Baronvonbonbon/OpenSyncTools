...
const setValue = (args, valExpr) => {
    ...
    if (dontOmitempty) {
        valExpr = t.logicalExpression("??", valExpr, getDefaultTSTypeFromProtoType(args.context, args.field, args.isOneOf));
    }
...
export const toAminoJSON = {
    ...
    protoType(args) {
        ...
        const dontOmitempty = args.field.options["(amino.dont_omitempty)"];
        let defaultValue = dontOmitempty ? getDefaultTSTypeFromProtoType(args.context, args.field, args.isOneOf) : t.identifier('undefined');
