...
exports.arrayTypes = exports.fromJSON = void 0;
...
exports.fromJSON = {
    ...
    long(args) {
        ...
        return t.objectProperty(t.identifier(messageProp), t.conditionalExpression(t.callExpression(t.identifier('isSet'), [
            t.memberExpression(t.identifier('object'), t.identifier(objProp))
        ]), utils_1.TypeLong.getFromValueWithArgs(args.context, t.memberExpression(t.identifier('object'), t.identifier(objProp))), (0, types_1.getDefaultTSTypeFromProtoType)(args.context, args.field, args.isOneOf)));
    },
    int64(args) {
