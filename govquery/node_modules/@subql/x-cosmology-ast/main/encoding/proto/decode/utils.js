...
exports.switchArray = exports.switchTagDelimArray = exports.switchAnyTypeArrayUseInterfaces = exports.switchAnyTypeArray = exports.switchAnyTypeArrayUnwrap = exports.switchProtoTypeArray = exports.switchOnTagTakesArray = exports.switchOnTag = exports.baseTypes = exports.decode = void 0;
...
exports.decode = {
    string(args) {
        ...
        return (0, exports.switchOnTag)(num, prop, exports.baseTypes.string(args));
    },
    bool(args) {
        const num = args.field.id;
        const prop = args.field.name;
        return (0, exports.switchOnTag)(num, prop, exports.baseTypes.bool(args));
    },
    double(args) {
        const num = args.field.id;
        const prop = args.field.name;
        return (0, exports.switchOnTag)(num, prop, exports.baseTypes.double(args));
    },
    float(args) {
        const num = args.field.id;
        const prop = args.field.name;
        return (0, exports.switchOnTag)(num, prop, exports.baseTypes.float(args));
    },
    int32(args) {
        const num = args.field.id;
        const prop = args.field.name;
        return (0, exports.switchOnTag)(num, prop, exports.baseTypes.int32(args));
    },
    sint32(args) {
        const num = args.field.id;
        const prop = args.field.name;
        return (0, exports.switchOnTag)(num, prop, exports.baseTypes.sint32(args));
    },
    uint32(args) {
        const num = args.field.id;
        const prop = args.field.name;
        return (0, exports.switchOnTag)(num, prop, exports.baseTypes.uint32(args));
    },
    fixed32(args) {
        const num = args.field.id;
        const prop = args.field.name;
        return (0, exports.switchOnTag)(num, prop, exports.baseTypes.fixed32(args));
    },
    sfixed32(args) {
        const num = args.field.id;
        const prop = args.field.name;
        return (0, exports.switchOnTag)(num, prop, exports.baseTypes.sfixed32(args));
    },
    int64(args) {
        const num = args.field.id;
        const prop = args.field.name;
        return (0, exports.switchOnTag)(num, prop, exports.baseTypes.int64(args));
    },
    sint64(args) {
        const num = args.field.id;
        const prop = args.field.name;
        return (0, exports.switchOnTag)(num, prop, exports.baseTypes.sint64(args));
    },
    uint64(args) {
        const num = args.field.id;
        const prop = args.field.name;
        return (0, exports.switchOnTag)(num, prop, exports.baseTypes.uint64(args));
    },
    fixed64(args) {
        const num = args.field.id;
        const prop = args.field.name;
        return (0, exports.switchOnTag)(num, prop, exports.baseTypes.fixed64(args));
    },
    sfixed64(args) {
        const num = args.field.id;
        const prop = args.field.name;
        return (0, exports.switchOnTag)(num, prop, exports.baseTypes.sfixed64(args));
    },
    duration(args) {
        const num = args.field.id;
        const prop = args.field.name;
        ...
        switch (durationFormat) {
            case 'string':
                return (0, exports.switchOnTag)(num, prop, exports.baseTypes.durationString(args));
            case 'duration':
            default:
                return (0, exports.switchOnTag)(num, prop, exports.baseTypes.type(args));
        }
    },
    timestamp(args) {
        const num = args.field.id;
        ...
        switch (timestampFormat) {
            case 'timestamp':
                return (0, exports.switchOnTag)(num, prop, exports.baseTypes.timestamp(args));
            case 'date':
            default:
                return (0, exports.switchOnTag)(num, prop, exports.baseTypes.timestampDate(args));
        }
    },
    type(args) {
        const num = args.field.id;
    ...
    enum(args) {
        const num = args.field.id;
        const prop = args.field.name;
        return (0, exports.switchOnTag)(num, prop, exports.baseTypes.enum(args));
    },
    bytes(args) {
        const num = args.field.id;
        const prop = args.field.name;
        return (0, exports.switchOnTag)(num, prop, exports.baseTypes.bytes(args));
    },
    keyHash(args) {
        const num = args.field.id;
        const prop = args.field.name;
        return (0, exports.switchOnTagTakesArray)(num, prop, exports.baseTypes.keyHash(args));
    },
    tagDelimArray(args, expr) {
        const num = args.field.id;
        const prop = args.field.name;
        return (0, exports.switchTagDelimArray)(num, prop, expr);
    },
    array(args, expr) {
        const num = args.field.id;
        const prop = args.field.name;
        return (0, exports.switchArray)(num, prop, expr);
    },
    typeArray(args) {
        const num = args.field.id;
        const prop = args.field.name;
        ...
        if (!args.context.options.aminoEncoding.useLegacyInlineEncoding &&
            ...
            if (isGlobalRegistry) {
                return (0, exports.switchAnyTypeArrayUnwrap)(num, prop, name);
            }
            const interfaceName = args.field.options['(cosmos_proto.accepts_interface)'];
            const interfaceFnName = (0, __1.getInterfaceDecoderName)(interfaceName);
            return args.context.options.interfaces.enabled && args.context.options.interfaces.useUseInterfacesParams ? (0, exports.switchAnyTypeArrayUseInterfaces)(num, prop, name, interfaceFnName) : (0, exports.switchAnyTypeArray)(num, prop, name);
        }
        return (0, exports.switchProtoTypeArray)(args, num, prop, name);
    }
};
exports.baseTypes = {
    // reader.string();
    ...
    long(type, args) {
        ...
        switch (utils_1.TypeLong.getType(args.context)) {
            case 'BigInt':
                return t.callExpression(t.memberExpression(t.identifier('reader'), t.identifier(type)), []);
            case 'Long':
            default:
                return t.tsAsExpression(t.callExpression(t.memberExpression(t.identifier('reader'), t.identifier(type)), []), t.tsTypeReference(utils_1.TypeLong.getPropIdentifier(args.context)));
        }
    },
    // (reader.int64() as Long);
    int64(args) {
        return exports.baseTypes.long('int64', args);
    },
    // (reader.sint64() as Long);
    sint64(args) {
        return exports.baseTypes.long('sint64', args);
    },
    // (reader.uint64() as Long);
    uint64(args) {
        return exports.baseTypes.long('uint64', args);
    },
    // (reader.fixed64() as Long);
    fixed64(args) {
        return exports.baseTypes.long('fixed64', args);
    },
    // (reader.sfixed64() as Long);
    sfixed64(args) {
        return exports.baseTypes.long('sfixed64', args);
    },
    ...
    anyType(args) {
        ...
        return args.context.options.interfaces.enabled && args.context.options.interfaces.useUseInterfacesParams ? t.conditionalExpression(t.identifier('useInterfaces'), asAny, exports.baseTypes.protoType(args)) : asAny;
    },
    type(args) {
        if (!args.context.options.aminoEncoding.useLegacyInlineEncoding &&
            args.context.options.interfaces.enabled &&
            args.field.type === 'google.protobuf.Any' &&
            args.field.options['(cosmos_proto.accepts_interface)']) {
            return exports.baseTypes.anyType(args);
        }
        return exports.baseTypes.protoType(args);
    },
    // (reader.int32() as any);
    enum(args) {
    ...
    keyHash(args) {
        ...
        return [
            t.variableDeclaration('const', [
                t.variableDeclarator(t.identifier(entryVariable), t.callExpression(t.memberExpression(t.identifier((0, __1.getKeyTypeEntryName)(name, prop)), t.identifier('decode')), [
                    t.identifier('reader'),
                    t.callExpression(t.memberExpression(t.identifier('reader'), t.identifier('uint32')), [])
                ]))
            ]),
...
const switchOnTag = (num, prop, expr) => {
...
const switchOnTagTakesArray = (num, prop, expr) => {
    return t.switchCase(t.numericLiteral(num), [
        ...expr,
        t.breakStatement()
    ]);
...
const switchProtoTypeArray = (args, num, prop, name) => {
    return t.switchCase(t.numericLiteral(num), [
...
const switchAnyTypeArrayUnwrap = (num, prop, name) => {
    return t.switchCase(t.numericLiteral(num), [
        t.expressionStatement(t.callExpression(t.memberExpression(t.memberExpression(t.identifier('message'), t.identifier(prop)), t.identifier('push')), [
...
exports.switchAnyTypeArrayUnwrap = switchAnyTypeArrayUnwrap;
const switchAnyTypeArray = (num, prop, name) => {
    return t.switchCase(t.numericLiteral(num), [
        t.expressionStatement(t.callExpression(t.memberExpression(t.memberExpression(t.identifier("message"), t.identifier(prop)), t.identifier("push")), [
...
const switchAnyTypeArrayUseInterfaces = (num, prop, typeName, interfaceName) => {
    return (0, exports.switchArray)(num, prop, t.conditionalExpression(t.identifier('useInterfaces'), t.tsAsExpression(t.callExpression(t.identifier(interfaceName), [
        t.identifier('reader')
...
exports.switchAnyTypeArrayUseInterfaces = switchAnyTypeArrayUseInterfaces;
// if ((tag & 7) === 2) {
...
//     message.codeIds.push((reader.uint64() as Long));
// }
const switchTagDelimArray = (num, prop, expr) => {
...
const switchArray = (num, prop, expr) => {
    return t.switchCase(t.numericLiteral(num), [
        t.expressionStatement(t.callExpression(t.memberExpression(t.memberExpression(t.identifier('message'), t.identifier(prop)), t.identifier('push')), [
            expr
        ])),
