...
exports.arrayTypes = exports.types = exports.encode = void 0;
...
const scalarType = (num, prop, type, args) => {
    ...
    return t.blockStatement([
        t.expressionStatement(t.callExpression(t.memberExpression(t.callExpression(t.memberExpression(t.identifier('writer'), t.identifier('uint32')), [
...
exports.encode = {
    string(args) {
        ...
        const num = (0, types_1.getTagNumber)(args.field);
        return exports.types.string(num, prop, args.isOptional, args);
    },
    double(args) {
        const prop = args.field.name;
        const num = (0, types_1.getTagNumber)(args.field);
        return exports.types.double(num, prop, args.isOptional, args);
    },
    float(args) {
        const prop = args.field.name;
        const num = (0, types_1.getTagNumber)(args.field);
        return exports.types.float(num, prop, args.isOptional, args);
    },
    int32(args) {
        const prop = args.field.name;
        const num = (0, types_1.getTagNumber)(args.field);
        return exports.types.int32(num, prop, args.isOptional, args);
    },
    sint32(args) {
        const prop = args.field.name;
        const num = (0, types_1.getTagNumber)(args.field);
        return exports.types.sint32(num, prop, args.isOptional, args);
    },
    uint32(args) {
        const prop = args.field.name;
        const num = (0, types_1.getTagNumber)(args.field);
        return exports.types.uint32(num, prop, args.isOptional, args);
    },
    fixed32(args) {
        const prop = args.field.name;
        const num = (0, types_1.getTagNumber)(args.field);
        return exports.types.fixed32(num, prop, args.isOptional, args);
    },
    sfixed32(args) {
        const prop = args.field.name;
        const num = (0, types_1.getTagNumber)(args.field);
        return exports.types.sfixed32(num, prop, args.isOptional, args);
    },
    int64(args) {
        const prop = args.field.name;
        const num = (0, types_1.getTagNumber)(args.field);
        return exports.types.int64(num, prop, args.isOptional, args);
    },
    sint64(args) {
        const prop = args.field.name;
        const num = (0, types_1.getTagNumber)(args.field);
        return exports.types.sint64(num, prop, args.isOptional, args);
    },
    uint64(args) {
        const prop = args.field.name;
        const num = (0, types_1.getTagNumber)(args.field);
        return exports.types.uint64(num, prop, args.isOptional, args);
    },
    fixed64(args) {
        const prop = args.field.name;
        const num = (0, types_1.getTagNumber)(args.field);
        return exports.types.fixed64(num, prop, args.isOptional, args);
    },
    sfixed64(args) {
        const prop = args.field.name;
        const num = (0, types_1.getTagNumber)(args.field);
        return exports.types.sfixed64(num, prop, args.isOptional, args);
    },
    bool(args) {
        const prop = args.field.name;
        const num = (0, types_1.getTagNumber)(args.field);
        return exports.types.bool(num, prop, args.isOptional, args);
    },
    type(args) {
        const prop = args.field.name;
        ...
        return exports.types.type(num, prop, name, isAnyType, isGlobalRegistry);
    },
    enum(args) {
        const num = (0, types_1.getTagNumber)(args.field);
        return exports.types.enum(args.context, num, args.field, args.isOptional, args.isOneOf);
    },
    bytes(args) {
        const prop = args.field.name;
        const num = (0, types_1.getTagNumber)(args.field);
        return exports.types.bytes(num, prop, args.isOptional);
    },
    timestamp(args) {
        const prop = args.field.name;
        const num = (0, types_1.getTagNumber)(args.field);
        ...
        switch (timestampFormat) {
            case 'timestamp':
                return exports.types.timestamp(num, prop);
            case 'date':
            default:
                args.context.addUtil('toTimestamp');
                return exports.types.timestampDate(num, prop);
        }
    },
    duration(args) {
        const prop = args.field.name;
        ...
        switch (durationFormat) {
            case 'string':
                ...
                return exports.types.duration(num, prop);
            case 'duration':
            default:
                return exports.encode.type(args);
        }
    },
    forkDelimArray(args, expr) {
        const prop = args.field.name;
        const num = (0, types_1.getTagNumber)(args.field);
        return exports.types.forkDelimArray(num, prop, expr);
    },
    array(args, expr) {
        const prop = args.field.name;
        const num = (0, types_1.getTagNumber)(args.field);
        return exports.types.array(num, prop, expr);
    },
    typeArray(args) {
        const prop = args.field.name;
        const name = args.context.getTypeName(args.field);
        ...
        const isGlobalRegistry = args.context.options.interfaces?.enabled && args.context.options.interfaces?.useGlobalDecoderRegistry;
        return exports.types.typeArray(num, prop, name, isAnyType, isGlobalRegistry);
    },
    keyHash(args) {
        const prop = args.field.name;
        const name = args.typeName;
        const num = (0, types_1.getTagNumber)(args.field);
        return exports.types.keyHash(num, prop, name);
    }
};
exports.types = {
    /*
    ...
    */
    string(num, prop, isOptional, args) {
        ...
        return t.ifStatement(wrapOptional(prop, notEmptyString(prop), isOptional, args), useCosmosSDKDec && isCosmosSDKDec
    ...
    */
    double(num, prop, isOptional, args) {
        return t.ifStatement(wrapOptional(prop, notZero(prop), isOptional, args), scalarType(num, prop, 'double'));
    },
    /*
    ...
    */
    float(num, prop, isOptional, args) {
        return t.ifStatement(wrapOptional(prop, notZero(prop), isOptional, args), scalarType(num, prop, 'float'));
    },
    //   if (message.int32Value !== 0) {
    //     writer.uint32(24).int32(message.int32Value);
    //   }
    int32(num, prop, isOptional, args) {
        return t.ifStatement(wrapOptional(prop, notZero(prop), isOptional, args), scalarType(num, prop, 'int32'));
    },
    //   if (message.sint32Value !== 0) {
    //     writer.uint32(24).sint32(message.sint32Value);
    //   }
    sint32(num, prop, isOptional, args) {
        return t.ifStatement(wrapOptional(prop, notZero(prop), isOptional, args), scalarType(num, prop, 'sint32'));
    },
    //   if (message.int32Value !== 0) {
    //     writer.uint32(24).uint32(message.int32Value);
    //   }
    uint32(num, prop, isOptional, args) {
        return t.ifStatement(wrapOptional(prop, notZero(prop), isOptional, args), scalarType(num, prop, 'uint32'));
    },
    fixed32(num, prop, isOptional, args) {
        return t.ifStatement(wrapOptional(prop, notZero(prop), isOptional, args), scalarType(num, prop, 'fixed32'));
    },
    sfixed32(num, prop, isOptional, args) {
        return t.ifStatement(wrapOptional(prop, notZero(prop), isOptional, args), scalarType(num, prop, 'sfixed32'));
    },
    //   if (!message.int64Value.isZero()) {
    //     writer.uint32(24).int64(message.int64Value);
    //   }
    int64(num, prop, isOptional, args) {
        return t.ifStatement(wrapOptional(prop, utils_1.TypeLong.getLongNotZero(prop, args.context), isOptional, args), scalarType(num, prop, 'int64', args));
    },
    //   if (!message.sint64Value.isZero()) {
    //     writer.uint32(24).sint64(message.sint64Value);
    //   }
    sint64(num, prop, isOptional, args) {
        return t.ifStatement(wrapOptional(prop, utils_1.TypeLong.getLongNotZero(prop, args.context), isOptional, args), scalarType(num, prop, 'sint64', args));
    },
    //   if (!message.int64Value.isZero()) {
    //     writer.uint32(24).uint64(message.int64Value);
    //   }
    uint64(num, prop, isOptional, args) {
        return t.ifStatement(wrapOptional(prop, utils_1.TypeLong.getLongNotZero(prop, args.context), isOptional, args), scalarType(num, prop, 'uint64', args));
    },
    fixed64(num, prop, isOptional, args) {
        return t.ifStatement(wrapOptional(prop, utils_1.TypeLong.getLongNotZero(prop, args.context), isOptional, args), scalarType(num, prop, 'fixed64', args));
    },
    sfixed64(num, prop, isOptional, args) {
        return t.ifStatement(wrapOptional(prop, utils_1.TypeLong.getLongNotZero(prop, args.context), isOptional, args), scalarType(num, prop, 'sfixed64', args));
    },
    ...
    enum(context, num, field, isOptional, isOneOf) {
        ...
        return t.ifStatement(wrapOptional(prop, t.binaryExpression('!==', t.memberExpression(t.identifier('message'), t.identifier(field.name)), (0, types_2.getDefaultTSTypeFromProtoType)(context, field, isOneOf)), isOptional), scalarType(num, prop, 'int32'));
    },
    /*
    ...
    keyHash(num, prop, name) {
        return t.expressionStatement(t.callExpression(t.memberExpression(t.callExpression(t.memberExpression(t.identifier('Object'), t.identifier('entries')), [
            ...
            t.arrowFunctionExpression([
                ...
                t.expressionStatement(t.callExpression(t.memberExpression(t.callExpression(t.memberExpression(t.identifier((0, __1.getKeyTypeEntryName)(name, prop)), t.identifier('encode')), [
                    t.objectExpression([
...
exports.arrayTypes = {
    double() {
        return t.expressionStatement(t.callExpression(t.memberExpression(t.identifier('writer'), t.identifier('double')), [
            t.identifier('v')
        ]));
    },
    bool() {
        return t.expressionStatement(t.callExpression(t.memberExpression(t.identifier('writer'), t.identifier('bool')), [
            t.identifier('v')
        ]));
    },
    float() {
        return t.expressionStatement(t.callExpression(t.memberExpression(t.identifier('writer'), t.identifier('float')), [
            t.identifier('v')
        ]));
    },
    int32() {
        return t.expressionStatement(t.callExpression(t.memberExpression(t.identifier('writer'), t.identifier('int32')), [
            t.identifier('v')
        ]));
    },
    sint32() {
        return t.expressionStatement(t.callExpression(t.memberExpression(t.identifier('writer'), t.identifier('sint32')), [
            t.identifier('v')
        ]));
    },
    uint32() {
        return t.expressionStatement(t.callExpression(t.memberExpression(t.identifier('writer'), t.identifier('uint32')), [
            t.identifier('v')
        ]));
    },
    fixed32() {
        return t.expressionStatement(t.callExpression(t.memberExpression(t.identifier('writer'), t.identifier('fixed32')), [
            t.identifier('v')
        ]));
    },
    sfixed32() {
        return t.expressionStatement(t.callExpression(t.memberExpression(t.identifier('writer'), t.identifier('sfixed32')), [
            t.identifier('v')
        ]));
    },
    long(type, args) {
        let valueExpression = t.identifier('v');
        return t.expressionStatement(t.callExpression(t.memberExpression(t.identifier('writer'), t.identifier(type)), [
            valueExpression
        ]));
    },
    int64(args) {
        return exports.arrayTypes.long('int64', args);
    },
    sint64(args) {
        return exports.arrayTypes.long('sint64', args);
    },
    uint64(args) {
        return exports.arrayTypes.long('uint64', args);
    },
    fixed64(args) {
        return exports.arrayTypes.long('fixed64', args);
    },
    sfixed64(args) {
        return exports.arrayTypes.long('sfixed64', args);
    },
    string(args) {
        const useCosmosSDKDec = args.context.pluginValue('prototypes.typingsFormat.customTypes.useCosmosSDKDec');
        const isCosmosSDKDec = (args.field.options?.['(gogoproto.customtype)'] ==
        ...
        if (useCosmosSDKDec && isCosmosSDKDec) {
            args.context.addUtil("Decimal");
            valueExpression = t.memberExpression(t.callExpression(t.memberExpression(t.identifier('Decimal'), t.identifier('fromUserInput')), [
                valueExpression,
                t.numericLiteral(18)
            ]), t.identifier('atomics'));
        }
        return t.expressionStatement(t.callExpression(t.memberExpression(t.callExpression(t.memberExpression(t.identifier('writer'), t.identifier('uint32')), [
            t.numericLiteral(num)
        ]), t.identifier('string')), [
            valueExpression
        ]));
    ...
    enum() {
        return exports.arrayTypes.int32();
    }
};
