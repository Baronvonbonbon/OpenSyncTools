...
import { BaseTemplateDataSource, IProjectNetworkConfig, CommonSubqueryProject, FileReference, ProjectManifestV1_0_0, BlockFilter, BaseDataSource, BaseCustomDataSource, BaseHandler, SecondLayerHandlerProcessor_0_0_0, SecondLayerHandlerProcessor_1_0_0, DsProcessor } from '@subql/types-core';
 ...
 */
export interface NearCustomDatasource<K extends string = string, M extends NearMapping = NearMapping<NearCustomHandler>> extends BaseCustomDataSource<NearHandler, M> {
    /**
...
export type SecondLayerHandlerProcessorArray<K extends string, F extends Record<string, unknown>, T, DS extends NearCustomDatasource<K> = NearCustomDatasource<K>> = SecondLayerHandlerProcessor<NearHandlerKind.Block, F, T, DS> | SecondLayerHandlerProcessor<NearHandlerKind.Transaction, F, T, DS> | SecondLayerHandlerProcessor<NearHandlerKind.Action, F, T, DS> | SecondLayerHandlerProcessor<NearHandlerKind.Receipt, F, T, DS>;
export type NearDatasourceProcessor<K extends string, F extends Record<string, unknown>, DS extends NearCustomDatasource<K> = NearCustomDatasource<K>, P extends Record<string, SecondLayerHandlerProcessorArray<K, F, any, DS>> = Record<string, SecondLayerHandlerProcessorArray<K, F, any, DS>>> = DsProcessor<DS, P, JsonRpcProvider>;
export type SecondLayerHandlerProcessor<K extends NearHandlerKind, F extends Record<string, unknown>, E, DS extends NearCustomDatasource = NearCustomDatasource> = SecondLayerHandlerProcessor_0_0_0<K, RuntimeHandlerInputMap, RuntimeHandlerFilterMap, F, E, DS, JsonRpcProvider> | SecondLayerHandlerProcessor_1_0_0<K, RuntimeHandlerInputMap, RuntimeHandlerFilterMap, F, E, DS, JsonRpcProvider>;
export type NearProject<DS extends NearDatasource = NearRuntimeDatasource> = CommonSubqueryProject<IProjectNetworkConfig, NearRuntimeDatasource | DS, BaseTemplateDataSource<NearRuntimeDatasource> | BaseTemplateDataSource<DS>>;
export {};
