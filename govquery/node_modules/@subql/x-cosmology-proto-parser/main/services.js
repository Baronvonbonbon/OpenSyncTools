...
exports.parseService = exports.parseServiceUrl = void 0;
const parseServiceUrl = (options) => {
    let method = 'get';
...
const parseService = (obj) => {
    const fields = obj.fields ?? {};
    const options = obj.options ?? {};
    const pathInfo = (0, exports.parseServiceUrl)(options);
    if (!pathInfo)
        return;
    const mapping = {};
