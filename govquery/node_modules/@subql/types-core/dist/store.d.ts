...
export type FieldsExpression<T> = [field: keyof T, operator: SingleOperators, value: T[keyof T]] | [field: keyof T, operator: ArrayOperators, value: Array<T[keyof T]>];
export interface Entity {
    id: string;
    _name?: string;
    save?: () => Promise<void>;
}
export type CompatEntity<T> = Omit<Entity, 'id'> & {
    id: T;
};
