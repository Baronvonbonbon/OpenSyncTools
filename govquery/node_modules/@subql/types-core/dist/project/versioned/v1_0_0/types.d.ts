...
export interface ProjectManifestV1_0_0<D extends BaseDataSource = BaseDataSource, T extends BaseTemplateDataSource<D> = BaseTemplateDataSource<D>, C extends IProjectNetworkConfig = IProjectNetworkConfig> {
    name?: string;
    version: string;
    schema: {
        file: string;
