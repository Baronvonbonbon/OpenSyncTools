...
export interface BaseCustomDataSource<H extends BaseHandler = BaseHandler, T extends BaseMapping<H> = BaseMapping<H>> extends BaseDataSource<H, T>, BaseAssetsDataSource {
    /**
...
export type BaseTemplateDataSource<DS extends BaseDataSource = BaseDataSource> = Omit<DS, 'startBlock' | 'endBlock'> & TemplateBase;
export interface ProjectManifestBaseImplInterface<D extends BaseDeploymentV1_0_0Interface = BaseDeploymentV1_0_0Interface> {
    deployment: D;
}
