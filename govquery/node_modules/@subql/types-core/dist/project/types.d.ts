 ...
 */
export interface CommonSubqueryProject<N extends IProjectNetworkConfig = IProjectNetworkConfig, DS extends BaseDataSource = BaseDataSource, T extends BaseTemplateDataSource<DS> = BaseTemplateDataSource<DS>> {
    /**
 ...
 */
export interface IProjectNetworkConfig<EndpointConfig extends IEndpointConfig = IEndpointConfig> extends ProjectNetworkConfig<EndpointConfig> {
    /**
