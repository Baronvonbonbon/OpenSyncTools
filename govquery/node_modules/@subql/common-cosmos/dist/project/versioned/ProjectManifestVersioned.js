...
exports.CosmosProjectManifestVersioned = void 0;
...
class CosmosProjectManifestVersioned {
    _impl;
    constructor(projectManifest) {
        ...
        this._impl = (0, class_transformer_1.plainToInstance)(klass, projectManifest);
    }
    get asImpl() {
        return this._impl;
    }
...
exports.CosmosProjectManifestVersioned = CosmosProjectManifestVersioned;
