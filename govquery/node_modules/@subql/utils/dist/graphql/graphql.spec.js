...
describe('utils that handle schema.graphql', () => {
    ...
    `;
        const schema = (0, schema_1.buildSchemaFromDocumentNode)(graphqlSchema);
        const entities = (0, entities_1.getAllEntitiesRelations)(schema);
        expect((_a = entities.models) === null || _a === void 0 ? void 0 : _a[0].indexes.length).toEqual(2);
        expect((_b = entities.models) === null || _b === void 0 ? void 0 : _b[0].indexes[0].fields).toEqual(['field2']);
        expect((_c = entities.models) === null || _c === void 0 ? void 0 : _c[0].indexes[1].fields).toEqual(['field3']);
    });
});
