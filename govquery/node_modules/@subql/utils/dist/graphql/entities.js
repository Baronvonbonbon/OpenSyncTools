...
function getAllEntitiesRelations(_schema) {
    ...
    for (const entity of entities) {
        ...
        for (const field of Object.values(entity.getFields())) {
            ...
            const typeClass = (0, types_1.getTypeByScalarName)(typeString);
            ...
            // If is jsonField
                ...
                const directive = jsonObject.astNode.directives.find(({ name: { value } }) => value === constant_1.DirectiveName.JsonField);
                const argValue = (_b = (_a = directive === null || directive === void 0 ? void 0 : directive.arguments) === null || _a === void 0 ? void 0 : _a.find((arg) => arg.name.value === 'indexed')) === null || _b === void 0 ? void 0 : _b.value;
...
function packEntityField(typeString, field, isForeignKey) {
    return {
        ...
        type: isForeignKey ? types_2.FieldScalar.String : typeString,
        description: field.description,
        isArray: (0, graphql_1.isListType)((0, graphql_1.isNonNullType)(field.type) ? (0, graphql_1.getNullableType)(field.type) : field.type),
        nullable: !(0, graphql_1.isNonNullType)(field.type),
        isEnum: false,
...
function isBooleanValueNode(valueNode) {
    return (valueNode === null || valueNode === void 0 ? void 0 : valueNode.kind) === 'BooleanValue';
}
