...
export type CosmosProjectManifestV1_0_0 = ProjectManifestV1_0_0<CosmosRuntimeDatasource | CosmosCustomDatasource, RuntimeDatasourceTemplate | CustomDatasourceTemplate, CosmosNetworkConfig>;
...
export declare enum CosmosDatasourceKind {
 ...
 * @enum {string}
 */
export declare enum CosmosHandlerKind {
    /**
 ...
 */
export type CosmosRuntimeHandler = CosmosBlockHandler | CosmosTransactionHandler | CosmosMessageHandler | CosmosEventHandler;
 ...
 */
export interface CosmosRuntimeDatasource<M extends CosmosMapping<CosmosRuntimeHandler> = CosmosMapping<CosmosRuntimeHandler>> extends ICosmosDatasource<M> {
    /**
 ...
 */
export interface CosmosCustomDatasource<K extends string = string, M extends CosmosMapping = CosmosMapping<CosmosCustomHandler>, O = any> extends BaseCustomDataSource<CosmosHandler, M> {
    /**
...
export interface HandlerInputTransformer_0_0_0<T extends CosmosHandlerKind, E, DS extends CosmosCustomDatasource = CosmosCustomDatasource> {
    (input: CosmosRuntimeHandlerInputMap[T], ds: DS, api: CosmWasmClient, assets?: Record<string, string>): Promise<E>;
}
export interface HandlerInputTransformer_1_0_0<T extends CosmosHandlerKind, F, E, DS extends CosmosCustomDatasource = CosmosCustomDatasource> {
    (params: {
 ...
 */
export type CosmosProject<DS extends CosmosDatasource = CosmosRuntimeDatasource> = CommonSubqueryProject<CosmosNetworkConfig, CosmosRuntimeDatasource | DS, BaseTemplateDataSource<CosmosRuntimeDatasource> | BaseTemplateDataSource<DS>>;
export {};
