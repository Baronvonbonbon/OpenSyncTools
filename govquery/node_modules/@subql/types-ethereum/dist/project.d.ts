import { BaseTemplateDataSource, IProjectNetworkConfig, CommonSubqueryProject, FileReference, Processor, ProjectManifestV1_0_0, BaseDataSource, SecondLayerHandlerProcessor_0_0_0, SecondLayerHandlerProcessor_1_0_0, DsProcessor, BaseCustomDataSource, IEndpointConfig } from '@subql/types-core';
 ...
 */
export interface SubqlRuntimeDatasource<M extends SubqlMapping<SubqlRuntimeHandler> = SubqlMapping<SubqlRuntimeHandler>> extends BaseDataSource<SubqlRuntimeHandler, M> {
    /**
...
export interface SubqlCustomDatasource<K extends string = string, M extends SubqlMapping = SubqlMapping<SubqlCustomHandler>, O = any> extends BaseCustomDataSource<SubqlHandler, M> {
    /**
     * The kind of the datasource, which is `ethereum/Runtime`.
     * @type {K}
     */
...
export type SecondLayerHandlerProcessor<K extends EthereumHandlerKind, F extends Record<string, unknown>, // EthereumRuntimeFilterMap?
E, DS extends SubqlCustomDatasource = SubqlCustomDatasource> = SecondLayerHandlerProcessor_0_0_0<K, EthereumRuntimeHandlerInputMap, EthereumRuntimeFilterMap, F, E, DS, ApiWrapper> | SecondLayerHandlerProcessor_1_0_0<K, EthereumRuntimeHandlerInputMap, EthereumRuntimeFilterMap, F, E, DS, ApiWrapper>;
export type SecondLayerHandlerProcessorArray<K extends string, F extends Record<string, unknown>, T, DS extends SubqlCustomDatasource<K> = SubqlCustomDatasource<K>> = SecondLayerHandlerProcessor<EthereumHandlerKind.Block, F, T, DS> | SecondLayerHandlerProcessor<EthereumHandlerKind.Call, F, T, DS> | SecondLayerHandlerProcessor<EthereumHandlerKind.Event, F, T, DS>;
export type SubqlDatasourceProcessor<K extends string, F extends Record<string, unknown>, DS extends SubqlCustomDatasource<K> = SubqlCustomDatasource<K>, P extends Record<string, SecondLayerHandlerProcessorArray<K, F, any, DS>> = Record<string, SecondLayerHandlerProcessorArray<K, F, any, DS>>> = DsProcessor<DS, P, ApiWrapper>;
