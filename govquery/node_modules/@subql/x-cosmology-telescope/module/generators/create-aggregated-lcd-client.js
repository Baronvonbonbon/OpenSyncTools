...
import { getNestedProto, isRefIncluded, isRefExcluded } from '@subql/x-cosmology-proto-parser';
...
export const plugin = (builder) => {
    ...
    const progImports = queryContexts.reduce((m, c) => {
        ...
        const ctx = new TelescopeParseContext(c.ref, c.store, builder.options);
