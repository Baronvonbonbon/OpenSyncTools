...
const makeRPC = (builder, bundler, rpc) => {
    ...
    switch (builder.options?.rpcClients?.type) {
        case "grpc-gateway":
            rpcast = createScopedGrpcGatewayFactory(ctx.proto, obj, "createGrpcGateWayClient"
        ...
        case "tendermint":
            ...
            rpcast = createScopedRpcTmFactory(ctx.proto, obj, methodName
            // 'QueryClientImpl' // make option later
            );
            break;
        case "grpc-web":
            rpcast = createScopedGrpcWebFactory(ctx.proto, obj, "createGrpcWebClient");
            break;
        default:
            break;
    }
