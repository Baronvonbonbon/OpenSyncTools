import { isRefExcluded, createEmptyProtoRef } from '@subql/x-cosmology-proto-parser';
...
export const getPackagesBundled = (store) => {
    ...
    Object.keys(pkgs).forEach(key => {
        if (isRefExcluded(createEmptyProtoRef(key), store.options.prototypes?.excluded))
            return;
