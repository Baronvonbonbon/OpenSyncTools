...
const sanitizeOptions = (options) => {
    ...
    options = (0, deepmerge_1.default)(x_cosmology_types_1.defaultTelescopeOptions, options ?? {});
...
class TelescopeBuilder {
    ...
    constructor({ protoDirs, outPath, store, options }) {
        ...
        this.store = store ?? new x_cosmology_proto_parser_1.ProtoStore(protoDirs, this.options);
