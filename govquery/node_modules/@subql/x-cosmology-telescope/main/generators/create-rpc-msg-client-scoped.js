...
const makeRPC = (builder, bundler, rpc) => {
    ...
    switch (builder.options?.rpcClients?.type) {
        ...
        case "tendermint":
            ...
            rpcast = (0, x_cosmology_ast_1.createScopedRpcFactory)(obj, methodName, 'MsgClientImpl' // make option later
            );
            if (rpc.isAll && ctx.proto.pluginValue('env') === 'v-next' && ctx.proto.pluginValue('rpcClients.extensions') && ctx.proto.pluginValue('stargateClients.addGetTxRpc')) {
                ...
                txRpcImport = (0, x_cosmology_ast_1.importStmt)([txRpcName], './client');
                msgExt = (0, x_cosmology_ast_1.createRpcMsgExtension)(ctx.proto, txRpcName);
            }
            break;
        case "grpc-web":
            ctx.proto.addUtil('grpc');
            ctx.proto.addUtil('NodeHttpTransport');
            rpcast = (0, x_cosmology_ast_1.createScopedGrpcWebMsgFactory)(obj, methodName, 'MsgClientImpl' // make option later
            );
            break;
        default:
            break;
