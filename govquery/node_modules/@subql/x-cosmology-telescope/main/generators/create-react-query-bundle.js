...
const x_cosmology_utils_3 = require("@subql/x-cosmology-utils");
const plugin = (builder) => {
    ...
    nameMapping = (0, x_cosmology_utils_3.swapKeyValue)(nameMapping ?? {});
    bundlerFiles.map(bundlerFile => {
        ...
        bundlerFile.instantExportedMethods?.forEach((method) => {
            ...
            const useHookName = (0, x_cosmology_utils_1.makeUseHookName)((0, x_cosmology_utils_1.camel)(methodName));
            ...
            if (nameMapping[hookNameWithPkg]) {
                ...
                if (methodSet.has(useHookName)) {
                    instantHookName = (0, x_cosmology_utils_1.makeUsePkgHookName)(bundlerFile.package, methodName);
                }
                else {
            ...
            dotty.put(instantHooksMapping, instantHookName, {
                useHookName,
                importedVarName: (0, x_cosmology_utils_2.variableSlug)(path),
    ...
    const pkg = '@root';
    const ref = (0, x_cosmology_proto_parser_1.createEmptyProtoRef)(pkg, localname);
    // create context
    ...
    const ast = (0, x_cosmology_ast_1.createScopedRpcHookFactory)(pCtx.proto, obj, 'createRpcQueryHooks', instantHooksMapping);
