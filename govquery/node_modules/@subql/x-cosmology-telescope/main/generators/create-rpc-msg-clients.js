...
const plugin = (builder, bundler) => {
    ...
    const clients = mutationContexts.map(c => {
        ...
        switch (c.proto.pluginValue("rpcClients.type")) {
            case 'grpc-gateway':
                asts.push((0, x_cosmology_ast_1.createGRPCGatewayMsgClass)(ctx.generic, proto.Msg));
                break;
            case 'grpc-web':
                asts.push((0, x_cosmology_ast_1.createGrpcWebMsgInterface)(ctx.generic, proto.Msg));
                asts.push((0, x_cosmology_ast_1.createGrpcWebMsgClass)(ctx.generic, proto.Msg));
                asts.push((0, x_cosmology_ast_1.GetDesc)(ctx.generic, proto.Msg));
                const Desces = (0, x_cosmology_ast_1.getMethodDesc)(ctx.generic, proto.Msg);
            ...
            case 'tendermint':
            default:
                asts.push((0, x_cosmology_ast_1.createRpcClientInterface)(ctx.generic, proto.Msg));
                const svc = proto.Msg;
                ...
                instantOps.forEach((item) => {
                    ...
                    const methodKeys = (0, x_cosmology_utils_1.getQueryMethodNames)(bundlerFile.package, Object.keys(svc.methods ?? {}), patterns, useCamelCase ? x_cosmology_utils_1.camel : String);
                ...
                asts.push((0, x_cosmology_ast_1.createRpcClientClass)(ctx.generic, proto.Msg));
