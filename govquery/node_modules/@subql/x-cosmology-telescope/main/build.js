...
const buildBaseTypeScriptClass = (context, name, obj) => {
    if (context.options.prototypes.enabled) {
        context.body.push((0, x_cosmology_ast_1.createCreateProtoType)(context.proto, name, obj));
        context.body.push((0, x_cosmology_ast_1.createObjectWithMethods)(context.proto, name, obj));
        if (context.options.interfaces?.enabled && context.options.interfaces?.useGlobalDecoderRegistry) {
            const registerObj = (0, x_cosmology_ast_1.createRegisterObject)(context.proto, name, obj);
            if (registerObj) {
                context.body.push(registerObj);
                //createRegisterAminoProtoMapping
                const registerAminoObj = (0, x_cosmology_ast_1.createRegisterAminoProtoMapping)(context.proto, name, obj);
                if (registerAminoObj) {
...
const buildBaseTypeScriptInterface = (context, name, obj) => {
    context.body.push((0, x_cosmology_ast_1.createProtoType)(context.proto, name, obj));
    if (context.options.aminoEncoding?.enabled && !context.options.aminoEncoding?.useLegacyInlineEncoding || context.options.prototypes?.methods?.fromProto || context.options.prototypes?.methods?.toProto) {
        context.body.push((0, x_cosmology_ast_1.createProtoTypeType)(context.proto, name, obj));
    }
    if (context.options.aminoEncoding?.enabled && !context.options.aminoEncoding?.useLegacyInlineEncoding) {
        // conditional type
        const interfaceType = (0, x_cosmology_ast_1.createProtoInterfaceEncodedType)(context.proto, name, obj);
        if (interfaceType) {
            context.body.push(interfaceType);
        }
        context.body.push((0, x_cosmology_ast_1.createAminoType)(context.proto, name, obj));
        if (!context.options.aminoEncoding?.disableMsgTypes) {
            context.body.push((0, x_cosmology_ast_1.createAminoTypeType)(context.proto, name, obj));
        }
    }
    if (context.options.useSDKTypes) {
        context.body.push((0, x_cosmology_ast_1.createSDKType)(context.proto, name, obj));
    }
};
exports.buildBaseTypeScriptInterface = buildBaseTypeScriptInterface;
const buildEnums = (context, name, obj) => {
    context.body.push((0, x_cosmology_ast_1.createProtoEnum)(context.proto, name, obj));
    if (context.options.useSDKTypes) {
        context.body.push((0, x_cosmology_ast_1.createEnumSDKType)(context.proto, name, obj));
    }
    if (context.options.aminoEncoding?.enabled && !context.options.aminoEncoding?.useLegacyInlineEncoding) {
        context.body.push((0, x_cosmology_ast_1.createEnumAminoType)(context.proto, name, obj));
    }
    context.body.push((0, x_cosmology_ast_1.createProtoEnumFromJSON)(context.proto, name, obj));
    context.body.push((0, x_cosmology_ast_1.createProtoEnumToJSON)(context.proto, name, obj));
};
exports.buildEnums = buildEnums;
class TelescopeParseContext {
    constructor(ref, store, options) {
        this.generic = new x_cosmology_ast_1.GenericParseContext(ref, store, options);
        this.proto = new x_cosmology_ast_1.ProtoParseContext(ref, store, options);
        this.amino = new x_cosmology_ast_1.AminoParseContext(ref, store, options);
        ...
        if (this.options.interfaces.enabled && !this.options.interfaces.useGlobalDecoderRegistry) {
            ...
            if (interfaces.length) {
                interfaces.forEach(interfaceName => {
                    this.body.push((0, x_cosmology_ast_1.createInterfaceDecoder)(this.proto, this.ref, interfaceName));
                    if (this.options.aminoEncoding?.enabled &&
                        !this.options.aminoEncoding?.useLegacyInlineEncoding) {
                        this.body.push((0, x_cosmology_ast_1.createInterfaceFromAmino)(this.proto, this.ref, interfaceName));
                        this.body.push((0, x_cosmology_ast_1.createInterfaceToAmino)(this.proto, this.ref, interfaceName));
                    }
                });
            }
        }
    ...
    buildRegistry() {
        this.body.push((0, x_cosmology_ast_1.createTypeRegistry)(this.amino, (0, exports.getMutations)(this.mutations)));
    }
    buildRegistryLoader() {
        if (!this.options?.prototypes?.enableRegistryLoader) {
            return;
        }
        this.body.push((0, x_cosmology_ast_1.createRegistryLoader)(this.amino));
    }
    buildAminoInterfaces() {
        ...
        protos.forEach(proto => {
            this.body.push((0, x_cosmology_ast_1.makeAminoTypeInterface)({
                context: this.amino,
                proto
            }));
        });
    ...
    buildAminoConverter() {
        this.body.push((0, x_cosmology_ast_1.createAminoConverter)({
            name: 'AminoConverter',
            context: this.amino,
    ...
    buildHelperObject() {
        ...
        // add methods
        this.body.push((0, x_cosmology_ast_1.createHelperObject)({
            context: this.amino,
