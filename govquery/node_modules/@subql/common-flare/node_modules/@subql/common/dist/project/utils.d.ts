import { FileReference, ProjectRootAndManifest } from '@subql/types-core';
...
export declare function findAvailablePort(startPort: number, range?: number): Promise<number | null>;
