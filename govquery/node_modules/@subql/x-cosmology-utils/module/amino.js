...
import { DEFAULT_AMINO_EXCEPTIONS, } from "@subql/x-cosmology-types";
...
export const getAminoTypeNameByRef = (ref, options, root, proto) => {
    if (!proto.name) {
    ...
    const modTypeUrlToAmino = getPluginValue("aminoEncoding.typeUrlToAmino", ref.proto.package, options);
