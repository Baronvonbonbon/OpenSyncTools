 ...
 */
export const makeUseHookName = (name) => {
    return camel("use_" + name);
};
export const makeUseHookNameWithCamel = (name) => {
    return camel("use_" + camel(name));
};
export const makeUsePkgHookName = (packageName, name) => {
    return variableSlug(`use_${packageName.replace(/\./g, "_")}_${snake(name)}`);
};
export const makePkgMethodName = (packageName, name) => {
    return variableSlug(`pkg_${packageName.replace(/\./g, "_")}_${snake(name)}`);
};
export const makeUseHookTypeName = (name) => {
    return pascal("Use_" + name + "Query");
};
export const makeHookKeyName = (name) => {
 ...
 */
export const getQueryMethodNames = (packagePath, methodKeys, patterns, makeMethodName) => {
 ...
 * @returns
 */
export const isRefIncluded = (ref, include) => {
 ...
 * @returns
 */
export const isRefExcluded = (ref, exclude) => {
    // if no include object, no filter
    if (!exclude)
        return false;
    // if no arrays are populated, no filter
