...
exports.ProjectManifestV1_0_0Impl = exports.DeploymentV1_0_0 = exports.ProjectNetworkV1_0_0 = exports.ProjectNetworkDeploymentV1_0_0 = exports.NearRunnerSpecsImpl = exports.CustomDatasourceTemplateImpl = exports.RuntimeDatasourceTemplateImpl = exports.NearCustomDataSourceImpl = exports.NearRuntimeDataSourceImpl = exports.NearRunnerNodeImpl = void 0;
const common_1 = require("@subql/common");
const class_transformer_1 = require("class-transformer");
const class_validator_1 = require("class-validator");
const models_1 = require("../../models");
const NEAR_NODE_NAME = `@subql/node-near`;
class NearRunnerNodeImpl extends common_1.RunnerNodeImpl {
    name = NEAR_NODE_NAME;
}
exports.NearRunnerNodeImpl = NearRunnerNodeImpl;
__decorate([
    (0, class_validator_1.Equals)(NEAR_NODE_NAME, { message: `Runner Near node name incorrect, suppose be '${NEAR_NODE_NAME}'` }),
    __metadata("design:type", String)
], NearRunnerNodeImpl.prototype, "name", void 0);
class NearRuntimeDataSourceImpl extends models_1.RuntimeDataSourceBase {
    validate() {
        return (0, common_1.validateObject)(this, 'failed to validate runtime datasource.');
    }
}
exports.NearRuntimeDataSourceImpl = NearRuntimeDataSourceImpl;
class NearCustomDataSourceImpl extends models_1.CustomDataSourceBase {
    validate() {
        return (0, common_1.validateObject)(this, 'failed to validate custom datasource.');
    }
}
exports.NearCustomDataSourceImpl = NearCustomDataSourceImpl;
class RuntimeDatasourceTemplateImpl extends NearRuntimeDataSourceImpl {
    name;
}
...
class CustomDatasourceTemplateImpl extends NearCustomDataSourceImpl {
    name;
}
...
class NearRunnerSpecsImpl {
    node;
    query;
}
exports.NearRunnerSpecsImpl = NearRunnerSpecsImpl;
__decorate([
    (0, class_validator_1.IsObject)(),
    (0, class_validator_1.ValidateNested)(),
    (0, class_transformer_1.Type)(() => NearRunnerNodeImpl),
    __metadata("design:type", Object)
], NearRunnerSpecsImpl.prototype, "node", void 0);
__decorate([
    (0, class_validator_1.IsObject)(),
    (0, class_validator_1.ValidateNested)(),
    (0, class_transformer_1.Type)(() => common_1.RunnerQueryBaseModel),
    __metadata("design:type", Object)
], NearRunnerSpecsImpl.prototype, "query", void 0);
...
], ProjectNetworkV1_0_0.prototype, "chaintypes", void 0);
...
__decorate([
    (0, class_validator_1.IsObject)(),
    (0, class_validator_1.ValidateNested)(),
    (0, class_transformer_1.Type)(() => NearRunnerSpecsImpl),
    __metadata("design:type", Object)
], DeploymentV1_0_0.prototype, "runner", void 0);
__decorate([
    (0, class_validator_1.IsArray)(),
    (0, class_validator_1.ValidateNested)(),
    (0, class_transformer_1.Type)(() => NearCustomDataSourceImpl, {
        discriminator: {
            property: 'kind',
