...
exports.NearProjectManifestVersioned = void 0;
...
class NearProjectManifestVersioned {
    _impl;
    constructor(projectManifest) {
        const klass = NEAR_SUPPORTED_VERSIONS[projectManifest.specVersion];
        if (!klass) {
...
exports.NearProjectManifestVersioned = NearProjectManifestVersioned;
