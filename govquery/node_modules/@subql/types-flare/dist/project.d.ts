import { BaseTemplateDataSource, IProjectNetworkConfig, CommonSubqueryProject, FileReference, Processor, ProjectManifestV1_0_0, BaseDataSource, SecondLayerHandlerProcessor_0_0_0, SecondLayerHandlerProcessor_1_0_0, DsProcessor } from '@subql/types-core';
...
E, DS extends SubqlCustomDatasource = SubqlCustomDatasource> = SecondLayerHandlerProcessor_0_0_0<EthereumRuntimeHandlerInputMap, K, F, E, DS, ApiWrapper> | SecondLayerHandlerProcessor_1_0_0<EthereumRuntimeHandlerInputMap, K, F, E, DS, ApiWrapper>;
