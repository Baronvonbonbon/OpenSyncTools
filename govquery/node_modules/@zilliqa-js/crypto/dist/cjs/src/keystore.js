...
function getDerivedKey(key, kdf, params) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_c) {
            salt = buffer_1.Buffer.from(params.salt, "hex");
            if (kdf === "pbkdf2") {
            ...
            if (kdf === "scrypt") {
                ...
                return [2 /*return*/, buffer_1.Buffer.from(derivedKeyInt8Array)];
            }
 ...
 */
var encryptPrivateKey = function (kdf, privateKey, passphrase) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
    ...
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                iv = buffer_1.Buffer.from((0, random_1.randomBytes)(16), "hex");
                kdfparams = {
                    salt: salt,
                    n: 8192,
                    c: 262144,
                ...
                return [4 /*yield*/, getDerivedKey(buffer_1.Buffer.from(passphrase), kdf, kdfparams)];
            case 1:
                derivedKey = _a.sent();
                cipher = new aes_js_1.default.ModeOfOperation.ctr(derivedKey.slice(0, 16), new aes_js_1.default.Counter(iv));
                ciphertext = buffer_1.Buffer.from(cipher.encrypt(buffer_1.Buffer.from(privateKey, "hex")));
                return [2 /*return*/, JSON.stringify({
                        ...
                        crypto: {
                            ...
                            mac: hash_js_1.default
                                ...
                                .update(buffer_1.Buffer.concat([
                                derivedKey.slice(16, 32),
                                ciphertext,
                                iv,
                                buffer_1.Buffer.from(ALGO_IDENTIFIER),
                            ]), "hex")
                                .digest("hex"),
                        },
 ...
 * @returns {Promise<string>}
 */
var decryptPrivateKey = function (passphrase, keystore) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
    var ciphertext, iv, kdfparams, derivedKey, mac, cipher;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ciphertext = buffer_1.Buffer.from(keystore.crypto.ciphertext, "hex");
                iv = buffer_1.Buffer.from(keystore.crypto.cipherparams.iv, "hex");
                kdfparams = keystore.crypto.kdfparams;
                return [4 /*yield*/, getDerivedKey(buffer_1.Buffer.from(passphrase), keystore.crypto.kdf, kdfparams)];
            case 1:
                derivedKey = _a.sent();
                mac = hash_js_1.default
                    // @ts-ignore
                ...
                cipher = new aes_js_1.default.ModeOfOperation.ctr(derivedKey.slice(0, 16), new aes_js_1.default.Counter(iv));
                return [2 /*return*/, buffer_1.Buffer.from(cipher.decrypt(ciphertext)).toString("hex")];
        }
    });
}); };
