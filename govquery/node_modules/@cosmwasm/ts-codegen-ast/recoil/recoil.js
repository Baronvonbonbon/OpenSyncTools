...
const createRecoilSelector = (context, keyPrefix, QueryClient, methodName, responseType) => {
    ...
    return t.exportNamedDeclaration(t.variableDeclaration('const', [
        t.variableDeclarator(t.identifier(selectorName), (0, utils_1.callExpression)(t.identifier('selectorFamily'), [
            t.objectExpression([
                ...
                t.objectProperty(t.identifier('get'), t.arrowFunctionExpression([
                    ...
                    t.returnStatement(t.awaitExpression(t.callExpression(t.memberExpression(t.identifier('client'), t.identifier(methodName)), [t.spreadElement(t.identifier('params'))]))),
                ]), true))),
            ]),
...
const createRecoilSelectors = (context, keyPrefix, QueryClient, queryMsg) => {
    return (0, utils_1.getMessageProperties)(queryMsg).map((schema) => {
...
const createRecoilQueryClient = (context, keyPrefix, QueryClient) => {
    ...
    return t.exportNamedDeclaration(t.variableDeclaration('const', [
        t.variableDeclarator(t.identifier('queryClient'), (0, utils_1.callExpression)(t.identifier('selectorFamily'), [
            t.objectExpression([
                t.objectProperty(t.identifier('key'), t.stringLiteral(getterKey)),
                t.objectProperty(t.identifier('get'), t.arrowFunctionExpression([
                    t.objectPattern([
