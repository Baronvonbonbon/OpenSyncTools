...
import { arrowFunctionExpression, bindMethod, classDeclaration, classProperty, FIXED_EXECUTE_PARAMS, getMessageProperties, getTypeOrRef, OPTIONAL_FUNDS_PARAM, promiseTypeAnnotation, typedIdentifier, } from '../utils';
...
export const CONSTANT_EXEC_PARAMS = [
    t.assignmentPattern(identifier('fee_', t.tsTypeAnnotation(t.tsUnionType([
        t.tSNumberKeyword(),
...
export const createExecuteClass = (context, className, implementsClassName, extendsClassName, execMsg) => {
    ...
    return t.exportNamedDeclaration(classDeclaration(className, [
        // client
        classProperty('client', t.tsTypeAnnotation(t.tsTypeReference(t.identifier('SigningCosmWasmClient'))), false, false, noImplicitOverride, useDeclareKeyword),
        // sender
        classProperty('sender', t.tsTypeAnnotation(t.tsStringKeyword())),
        // contractAddress
        classProperty('contractAddress', t.tsTypeAnnotation(t.tsStringKeyword()), false, false, noImplicitOverride, useDeclareKeyword),
        // constructor
        t.classMethod('constructor', t.identifier('constructor'), [
